...
export default function VideoChatPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-green-600 to-emerald-700">
      ...
      <div className="w-full max-w-5xl bg-white p-6 shadow-lg rounded-lg max-h-[80vh] flex flex-col relative">
        {/* X 버튼: 화상 통화 종료 */}
        <button
          ...
          aria-label="화상 통화 종료"
        >
          <img src={exitImg} alt="화상 통화 종료" className="w-10 h-10" />
        </button>

        {/* Video Section: 내 얼굴과 상대방 얼굴 */}
        <div className="w-[95%] h-[95%] flex-1 flex gap-4 mt-4">
          {/* 내 얼굴 */}
